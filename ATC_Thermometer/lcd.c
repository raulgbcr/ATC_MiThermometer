...
void show_atc(){
	send_to_lcd(0x00,0x00,0x02,0x00,0x00,0x00);
}

void show_atc_mac(){
	extern u8  mac_public[6];
	send_to_lcd(display_numbers[mac_public[2] &0x0f],display_numbers[mac_public[2]>>4],0x02,0x00,0x00,0x00);
	sleep_ms(1200);
	send_to_lcd(0x00,0x00,0x02,0x00,0x00,0x00);
	sleep_ms(200);
	send_to_lcd(display_numbers[mac_public[1] &0x0f],display_numbers[mac_public[1]>>4],0x02,0x00,0x00,0x00);
	sleep_ms(1200);
	send_to_lcd(0x00,0x00,0x02,0x00,0x00,0x00);
	sleep_ms(200);
	send_to_lcd(display_numbers[mac_public[0] &0x0f],display_numbers[mac_public[0]>>4],0x02,0x00,0x00,0x00);
	sleep_ms(1200);
}
